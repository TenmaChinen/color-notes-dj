"""
Django settings for color-notes project.
...
SECRET_KEY = 'django-insecure-bws65_1fsfxjkj4w(7wwu^e3&&ec3gb*7q@($e=1@c-)8#zszk'
...
WSGI_APPLICATION = 'color-notes.wsgi.application'
